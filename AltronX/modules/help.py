...
PythonHelp = f"★ ​4ꜱᴛ 𝘀𝗽𝗮𝗺 𝙃𝙚𝙡𝙥 𝙈𝙚𝙣𝙪 ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @CRAZY_URIXX**"
...
async def help(event):
    if event.sender_id in SUDO_USERS:
       await event.client.send_file(event.chat_id,
           ...
           [    
            Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/ll4st_opII"),
            Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/II_4ST_FIGHTER_ll")
           ],
           ],
           )
...
async def helpback(event):
   if event.query.user_id in SUDO_USERS:    
      await event.edit(
           ...
           [
            Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/ll4st_opII"),
            Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/II_4ST_FIGHTER_l")
           ],
           ],
        )           
   else:
        await event.answer("Pahle jaake baap bol 4ꜱᴛ ko wo tumhe sudo de dega", cache_time=0, alert=True)
